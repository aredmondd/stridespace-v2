...
<template>
  ...
  <div class="flex flex-col gap-4 items-center justify-center mx-12">
    ...
    <div class="flex gap-6 sm:gap-12">
      <RouterLink
        to="/login"
        class="font-martian-mono text-xl sm:text-2xl p-2 bg-purple text-black text-left hover:bg-white hover:text-black transition-all duration-500 ease-in-out"
        >login</RouterLink
      >
    </div>
  </div>
