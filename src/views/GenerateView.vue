...
const submitRun = async () => {
    try {
        const response = await fetch(`https://stridespace-art-generation.onrender.com/generate-art/?distance=${distance.value}&duration=${time.value}&emotion=${selectedEmotion.value || 'neutral'}`, {
            method: 'GET',
            headers: {
            ...
            <div class="flex flex-col ml-20">
                ...
                <div class="my-8">
                    ...
                    <div class="mt-2 relative">
                        ...
                        <span class="text-sm text-white/50 absolute start-1/2 -translate-x-1/2 -bottom-6">13</span>
                ...
                <div class="my-8">
                    ...
                    <div class="mt-2 relative">
                        ...
                        <span class="text-sm text-white/50 absolute start-1/2 -translate-x-1/2 -bottom-6">2hr</span>
                        ...
                        <div>
                            ...
                            <div class="mt-2 flex gap-2">
                                <span 
                                    ...
                                    :key="emotion.name"
                                    :class="[selectedEmotion === emotion.name ? emotion.color : 'text-white/50', 'material-symbols-outlined cursor-pointer transition-all duration-250 ease-in-out']"
                                    :style="{ fontSize: '45px' }"
