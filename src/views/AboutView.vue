  ...
  <div class="flex border-b-1 border-white/15">
    <div class="flex flex-col border-white/15 p-4">
      <div class="flex shrink items-end">
        ...
        <p class="opacity-25 ml-2 mb-1 text-sm">
          stride = most effective natural pace <br />space = distance? extent of a dimension? period
          of time?
        </p>
      </div>
      <div class="flex">
    ...
    <div class="border-l-1 border-white/15 flex grow gap-4 p-4">
      ...
      <div class="flex flex-col justify-between gap-4">
        ...
        <p class="opacity-50">
          i made stridespace to keep things fresh for me as an athlete and challenge me as a web
          developer.
        </p>
        <p class="opacity-50">
          you can see <span class="italic">exactly</span> how stridespace works and other things i'm
          up to
          <a
            href="https://github.com/aredmondd"
            target="_blank"
  ...
  <div class="border-t-1 border-white/15">
    ...
    <FAQ title="3. why is everything in lower case or upper case?">
      <p>
        ...
        <a
          href="https://martians-font.webflow.io/"
          target="_blank"
          class="underline underline-offset-2"
          >martian mono</a
        >.
    ...
    <FAQ title="5. you aren't making art. it's an algorithm.">
      ...
      <p>
        ...
        <a
          ...
          target="_blank"
          class="underline underline-offset-2"
          >generative art wikipedia</a
        >,
        <a
          href="https://plato.stanford.edu/entries/art-definition/"
          target="_blank"
          class="underline underline-offset-2"
          >stanford's definition of art</a
        >, and
        <a
          href="https://www.corralldesign.com/writing/ai-harm-hypocrisy"
          target="_blank"
          class="underline underline-offset-2"
          >the harm & hypocrisy of ai art</a
        >,
      </p>
    </FAQ>
