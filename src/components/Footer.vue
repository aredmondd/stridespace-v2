...
<template>
  ...
  <div class="sm:hidden flex flex-col">
    <div class="flex justify-between items-center mx-1">
      <RouterLink
        to="/about"
        class="flex items-center px-4 hover:text-purple transition-colors duration-250 ease-in-out hover:cursor-pointer"
        >about</RouterLink
      >
      <RouterLink
        to="/login"
    ...
    <p class="text-white opacity-25 font-martian-mono text-xs">
      all aspects of this website were designed and implemented by aiden redmond
    </p>
  </div>
    ...
    <div class="flex flex-col justify-center items-end gap-4 px-3 border-r-1 border-white/15">
      ...
      <p class="text-white/25 font-martian-mono text-sm">
        ...
        <a
          ...
          target="_blank"
          class="underline underline-offset-2 hover:text-purple hover:opacity-100 transition-all duration-250 ease-in-out"
          >aiden redmond</a
        >
      </p>
    </div>
